...
const { applyRankedResult, applyMoonveilDominionResult, applyMoonveilGlyphResult, applyStructuredGameResult } = require('./src/server/services/user-service');
...
registerSockets({ io, User, state, isGameAllowed, applyRankedResult, applyMoonveilDominionResult, applyMoonveilGlyphResult, applyStructuredGameResult });
