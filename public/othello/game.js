...
const TUTORIAL_STEPS=[
 ...
 {title:"Win with mobility",body:"Keep giving the AI fewer legal moves than you have. In Othello, the player with better options usually owns the endgame.",tips:["Small quiet flips are often stronger than huge flips.","Watch what the AI can play after your move."]},
...
function finishTutorialGame(){
 ...
 tutorialGuide?.complete(`${result}. Final score: Black ${score.b} - White ${score.w}. You played a complete guided Othello game against the coach AI.`);
 showEnd(result);
}
...
function startTutorialGame(){
 ...
 tutorialGuide=tutorialGuide||window.TutorialGuide?.create({
  ...
  onBack:()=>window.location.href="/othello/index.html"
 });
 draw();
 updateTutorialGuide();
}
